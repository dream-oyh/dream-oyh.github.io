...
export default sidebar({
  "/code/": [
    {
      text: "编程",
      link: "/code/",
      children: ["python.md", "Arduino/index.md", "Arduino/stm32.md", "cpp.md", "css.md", "vue.md"],
    },
    {
      text: "工具",
  ...
  "/articles/": [
    ...
    {
      text: "学校",
      children: ["CSU.md", "fool.md"],
    },
    {
      text: "爱好&生活",
      children: ["read.md", "travel.md", "video_game.md", "vibeImages.md"],
    },
  ],
  "/credit/": ["index.md"],
  "/blog/": ["index.md", "log.md", "vuepress.md", "spots.md"],
  "/study/": ["/study/DataStructure/", "/study/Algorithm/", "/study/ReinforcementLearning/", "proxy.md", "rov.md", "ros.md"],
  "/study/Algorithm/": [
    {
      text: "算法学习",
      icon: "code",
