<template>
  ...
  <div class="python" style="display: block-inline;">
    <img style="margin: 10px" src="https://avatars.githubusercontent.com/u/48722593?s=200&v=4" alt="poetry"
      height="40" />
    <img style="margin: 10px" src="https://profilinator.rishav.dev/skills-assets/python-original.svg" alt="Python"
      height="40" />
    <img style="margin: 10px" src="https://profilinator.rishav.dev/skills-assets/pytorch-icon.svg" alt="pytorch"
      height="40" />
  </div>
  ...
  <div class="cpp" style="display: block-inline;">
    ...
    <img style="margin: 10px"
      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcReNMgSPHBMdeqbNGq1hloDX6LT-aJyzGmOAQ&s" alt="stm32"
      height="40" />
    <img style="margin: 10px"
      src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/Robot_Operating_System_logo.svg/2048px-Robot_Operating_System_logo.svg.png"
      alt="ros" height="45" />
  </div>
  ...
  <div class="tool" style="display: block-inline;">
    <img style="margin: 10px" src="https://code.visualstudio.com/assets/images/code-stable.png" alt="VSCode"
      height="40" />
